...
srun --ntasks=16 --cpus-per-task=16 --cpu-bind=cores ./main -x 15000 -y 15000 -p 0 -o 0 -e 300 -v 1 > ./output/orfeo/strong_scaling/baseline/output_strong_2_node_8taskpernode_16cpupertask.log