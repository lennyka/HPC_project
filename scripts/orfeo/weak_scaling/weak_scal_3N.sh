...
srun --ntasks=24 --cpus-per-task=16 --ntasks-per-node=8 --cpu-bind=cores  ./main -x 25981 -y 25981 -p 0 -o 0 -e 300 -v 1 > ./output/orfeo/weak_scaling/output_weak_3_node_8taskpernode_16cpupertask.log 2>&1